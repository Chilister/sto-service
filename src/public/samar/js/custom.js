...
var Samar = function () {
  ...
  /* One Page Layout ============ */
  var onePageLayout = function onePageLayout() {
    'use strict';
  ...
  /* Header Height ============ */
  var handleResizeElement = function handleResizeElement() {
    $('.header').css('height', '');
  ...
  /* Footer Align ============ */
  var footerAlign = function footerAlign() {
    'use strict';
  ...
  /* Masonry Box ============ */
  var masonryBox = function masonryBox() {
    'use strict';
    ...
    if (jQuery('#masonry, .masonry').length > 0) {
      ...
      if (jQuery('.card-container').length > 0) {
        ...
        self.imagesLoaded(function () {
          filter: filterValue, self.masonry({
            gutter: gutter,
  ...
  /* Gallery Filter ============ */
  var handleFilterMasonary = function handleFilterMasonary() {
  ...
  var handleBootstrapSelect = function handleBootstrapSelect() {
  ...
  /* Resizebanner ============ */
  var handleBannerResize = function handleBannerResize() {
    $(".full-height").css("height", $(window).height());
  };

  /* Countdown ============ */
  var handleCountDown = function handleCountDown(WebsiteLaunchDate) {
    /* Time Countr Down Js */
    if ($(".countdown").length) {
      $('.countdown').countdown({
  ...
  var handlePlaceholderAnimation = function handlePlaceholderAnimation() {
  ...
  /* WOW ANIMATION ============ */
  var wow_animation = function wow_animation() {
    if ($('.wow').length > 0) {
      var wow = new WOW({
        boxClass: 'wow',
  ...
  /* Header Height ============ */
  var setResizeMargin = function setResizeMargin() {
  ...
  var handleBootstrapTouchSpin = function handleBootstrapTouchSpin() {
  ...
  var customFileUpload = function customFileUpload() {
  ...
  var handlePricingTabs = function handlePricingTabs() {
