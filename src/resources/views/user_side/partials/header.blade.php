                    ...
                    <ul class="nav navbar-nav navbar">
                        ...
                        <li class="active"><a href="javascript:void(0);"><span>Pages</span><i class="fa fa-chevron-down"></i></a>
                            <ul class="sub-menu">
                                ...
                                <li><a href="javascript:void(0);">Team Details <span class="badge">New</span><i class="fa fa-angle-right"></i></a>
                                    <ul class="sub-menu">
                                ...
                                <li><a href="company-history.html">Company History <span class="badge">New</span></a></li>
