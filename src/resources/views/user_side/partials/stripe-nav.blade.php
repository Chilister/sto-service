    ...
    <div class="container">
        <ul class="st-nav-menu nav navbar-nav">
            ...
            <li class="st-nav-section st-nav-primary nav-item {{ $navPrimaryClass }}">
                <x-utils.link class="st-root-link nav-link" :href="route('frontend.index')" :text="'Головна'" />
                <x-utils.link class="st-root-link nav-link" :href="route('pricing.categories')" :text="'Ціни'" />
